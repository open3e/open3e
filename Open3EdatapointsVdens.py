...
dataIdentifiersVdens = {
    ...
    0x680 : {
        ...
        "dids" : 
        {
            ...
            401 : RawCodec(5, "MixerOneCircuitPump"),
            402 : RawCodec(5, "MixerTwoCircuitPump"),
            403 : RawCodec(5, "MixerThreeCircuitPump"),
            404 : RawCodec(5, "MixerFourCircuitPump"),
            405 : RawCodec(5, "MixerFiveCircuitPump"),
            406 : RawCodec(5, "MixerSixCircuitPump"),
            407 : RawCodec(5, "MixerSevenCircuitPump"),
            408 : RawCodec(5, "MixerEightCircuitPump"),						
