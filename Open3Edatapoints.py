...
dataIdentifiers = {
    ...
    933 : RawCodec(9, "Mixer1Settings"),
    934 : RawCodec(9, "Mixer2Settings"),
    935 : RawCodec(9, "Mixer3Settings"),
    936 : RawCodec(9, "Mixer4Settings"),
    ...
    874 : RawCodec(3, "LegionellaProtectionTargetTempSetpoint"),
