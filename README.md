...
Attention: Option `-dev DEV, --dev DEV` is deprecated and will be removed in future versions. Use `-cnfg DEVICES.JSON` instead! 
...
## Using json data format
    open3e -c can0 -cnfg devices.json -j -w 396='47.5'
    -> sets domestic hot water setpoint to 47.5degC

    open3e -c can0 -cnfg devices.json -j -w 538='{"Mode": 1, "State": 0}'
